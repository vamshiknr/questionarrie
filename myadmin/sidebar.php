<div class="sidebar-nav">
    <ul>
        ...
        <li><ul class="dashboard-menu nav nav-list collapse in">
                <li><a href="<?php echo $admin_url; ?>/categories.php"><span class="fa fa-caret-right"></span> Categories</a></li>
                <li ><a href="<?php echo $admin_url; ?>/exams.php"><span class="fa fa-caret-right"></span> Exams</a></li>
